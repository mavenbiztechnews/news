...
<a class="skip-link screen-reader-text" href="#page"><?php _e( 'Skip to content', 'screenplan' ); ?></a>
...
<div id="wrapper">
	...
	<div id="wrapper-inner">
		...
		<div id="wrapper-inner-inner">
			...
			<header id="header">
				<div id="header-inner">
					<?php echo screenplan_site_title(); ?>
					<?php if ( display_header_text() == true ): ?>
						<p class="site-description"><?php bloginfo( 'description' ); ?></p>
					<?php endif; ?>

					<?php if ( get_theme_mod( 'header-social', 'on' ) == 'on' ): ?>
						<?php screenplan_social_links() ; ?>
					<?php endif; ?>

					<div id="move-sidebar-header"><?php get_sidebar(); ?></div>
			...
			<div class="main">
				...
				<?php if ( has_nav_menu('header') ): ?>
					<div id="wrap-nav-header" class="wrap-nav">
						<?php \Screenplan\Nav::nav_menu(array('theme_location'=>'header','menu_id' => 'nav-header','fallback_cb'=> false)); ?>
					</div>
				<?php endif; ?>
				
				<?php if ( has_nav_menu('mobile') ): ?>
					<div id="wrap-nav-mobile" class="wrap-nav">
						<?php \Screenplan\Nav::nav_menu(array('theme_location'=>'mobile','menu_id' => 'nav-mobile','fallback_cb'=> false)); ?>
					</div>
				<?php endif; ?>
